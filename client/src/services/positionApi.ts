...
export const authApi = {
  ...
  register: async (name: string, email: string, password: string, role: string, universityId: string): Promise<LoginResponse> => {
    const response = await axios.post(`${API_BASE_URL}/auth/register`, { name, email, password, role, universityId });
    return response.data;
  },
...
export const positionApi = {
  ...
  createPosition: async (positionData: Partial<Position>): Promise<Position> => {
